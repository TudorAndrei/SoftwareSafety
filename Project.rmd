...
# Defining accidents
An **accident** can be define as undesired or unplanned event that results in a loss, including loss of human life or human injury, property damage, environmental pollution, mission loss, etc. In order to find a cause for the accidents, they have to be put in context. In this case, the following accidents occurred:
...
The severity of the accidents could further be assesed using the following scale:
...
# Identifying hazards
In order to identify the hazards, the definition of the accident or loss is used with the additional safety critaria that will be imposed:

- (H1): Runway Incursion:

  Runway Incursion^[[source](https://web.archive.org/web/20071009153522/http://www.faa.gov/news/fact_sheets/news_story.cfm?newsId=9612)] is defined, in this case, as an occurence at an airport involving the incorrect presence of aircraft on the runway.
...
In the following figure the control structure of the system of airport is shown, at the time of the accident.
...
- Commerical aircraft should not taxi when the visibility ins uder 150 meters unless taxi indicators or other visual aids are operational.

- Landing lights hould be on, when an aircraft is moving.

- Redudant means for takeoff clearance confirmations should be used at all airport.

- In oder to minimize human error, the optimum number of crew members should be reasearched.
